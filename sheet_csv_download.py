...
def main():
    ...
    if folders:
        ...
        for folder in folders:
            ...
            query += '"' + folder['id'] + '" in parents and mimeType!="application/vnd.google-apps.folder" and trashed != true'
            print('ck2 folder:' + folder['id'] + " name:" + folder['name'])
        for childFolder in childFolders:
            if query != '' : query += ' or '
            # query += '"' + childFolder['id'] + '" in parents and trashed != true'
            query += '"' + childFolder['id'] + '" in parents and mimeType!="application/vnd.google-apps.folder" and trashed != true'
